...
{
	  for (int i = 1; i < 64; ++i)
	{   Reductions[i] = int(21.9 * log(i)); 
			//R[1]=0 R[2]=15 R[3]=24 R[4]=30 R[5]=35 R[6]=39 R[7]=42 R[8]=45 R[9]=48 R[10]=50 
			//R[11]=52 R[12]=54 R[13]=56 R[14]=57 R[15]=59 R[16]=60 R[17]=62 R[18]=63 R[19]=64 R[20]=65 
			//R[21]=66 R[22]=67 R[23]=68 R[24]=69 R[25]=70 R[26]=71 R[27]=72 R[28]=72 R[29]=73 R[30]=74 
			//R[31]=75 R[32]=75 R[33]=76 R[34]=77 R[35]=77 R[36]=78 R[37]=79 R[38]=79 R[39]=80 R[40]=80 
			//R[41]=81 R[42]=81 R[43]=82 R[44]=82 R[45]=83 R[46]=83 R[47]=84 R[48]=84 R[49]=85 R[50]=85 
			//R[51]=86 R[52]=86 R[53]=86 R[54]=87 R[55]=87 R[56]=88 R[57]=88 R[58]=88 R[59]=89 R[60]=89 
			//R[61]=90 R[62]=90 R[63]=90 
			//Reductions[i] = int( log(i)); 
			//R[1]=0 R[2]=0 R[3]=1 R[4]=1 R[5]=1 R[6]=1 R[7]=1 R[8]=2 
//R[9]=2 R[10]=2 R[11]=2 R[12]=2 R[13]=2 R[14]=2 R[15]=2 R[16]=2 
//R[17]=2 R[18]=2 R[19]=2 R[20]=2 R[21]=3 R[22]=3 R[23]=3 R[24]=3 
//R[25]=3 R[26]=3 R[27]=3 R[28]=3 R[29]=3 R[30]=3 R[31]=3 R[32]=3 
//R[33]=3 R[34]=3 R[35]=3 R[36]=3 R[37]=3 R[38]=3 R[39]=3 R[40]=3 
//R[41]=3 R[42]=3 R[43]=3 R[44]=3 R[45]=3 R[46]=3 R[47]=3 R[48]=3 
//R[49]=3 R[50]=3 R[51]=3 R[52]=3 R[53]=3 R[54]=3 R[55]=4 R[56]=4 
//R[57]=4 R[58]=4 R[59]=4 R[60]=4 R[61]=4 R[62]=4 R[63]=4 
		//printf("R[%d]=%d ", i, Reductions[i]);
		//if (i%10 == 0) printf("\n");
...
//	char *BackSlashPtr;
    ...
    */			
    //20230125 LocatePath(g_bookfile, "EYBOOK.DAT"); 
		...
		// 显示引擎的名称、版本、作者和使用者
		printf ("id name Eychessu V2023g\n"); fflush(stdout);   //20230110   V2.892w
